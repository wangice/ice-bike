...
import com.ice.bike.common.mogodb.MongoDao;
...
public interface MongoGeoDao extends MongoDao {
     ...
     * @return              非NULL的list 
     */  
    public List<DBObject> geoNear(String collection, DBObject query, DeviceLocationVo point,int limit, long maxDistance) ;  
     ...
     * @return              非NULL的list 
     */  
    public List<DBObject> nearSphere(String collection, String locationField, DeviceLocationVo center, long minDistance, long maxDistance, DBObject query, DBObject fields, int limit);  
